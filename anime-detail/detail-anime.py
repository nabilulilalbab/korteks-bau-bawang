...
def scrape_anime_details(url):
    ...
    try:
        ...
        anime_details['episode_list'] = sorted(episode_list, key=lambda x: int(x.get('episode', 0)), reverse=True)
...
if __name__ == "__main__":
    target_url = "https://samehadaku.now/anime/sakamoto-days-cour-2/"
